...
function guessUpstreamFile(slug: string): string | null {
  // Map docs/<locale>/<slug>.md → upstream-readings/<file>.rs
  // Each entry below points at a Rust excerpt of the corresponding upstream
  // codex-rs/* file, annotated for teaching.
  const map: Record<string, string> = {
    "s01-minimum-loop": "s01-protocol.rs",
    "s02-model-client": "s02-client.rs",
    "s03-exec-tool": "s03-exec.rs",
    "s04-apply-patch": "s04-apply-patch.rs",
    "s05-approval": "s05-approval.rs",
    "s06-execpolicy": "s06-execpolicy.rs",
    "s07-rollout": "s07-rollout.rs",
    "s08-sandbox": "s08-sandbox.rs",
    "s09-mcp-bridge": "s09-mcp.rs",
    "s10-cli-driver": "s10-cli.rs",
  };
